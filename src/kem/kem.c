...
#ifdef OQS_KEM_alg_ctruprime_653
		return 1;
#else 
		return 0;
#endif
	} else if( 0 == strcasecmp(method_name, OQS_KEM_alg_ctruprime_761)) {
#ifdef OQS_KEM_alg_ctruprime_761
		return 1;
#else 
		return 0;
#endif
	} else if( 0 == strcasecmp(method_name, OQS_KEM_alg_ctruprime_1277)) {
#ifdef OQS_KEM_alg_ctruprime_1277
		return 1;
#else 
		return 0;
#endif
